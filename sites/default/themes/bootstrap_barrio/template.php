<?php
   ...
   function bootstrap_barrio_preprocess_html(&$variables){
      ...
      if(theme_get_setting('toggle_responsive')){
         ...
         drupal_add_css(
            drupal_get_path('theme', 'bootstrap_barrio') . '/css/no-responsive.css',
    ...
    * Fahico...!
    */
   function bootstrap_barrio_theme(&$existing, $type, $theme, $path){

      $items = array();

      $items['user_login'] = array(
         'render element' => 'form',
         'path' => drupal_get_path('theme', 'bootstrap_barrio') . '/templates',
         'template' => 'user-login',
         'preprocess functions' => array('bootstrap_barrio_preprocess_user_login'),
      );
      ...
      $items['user_register_form'] = array(
         ...
         'preprocess functions' => array('bootstrap_barrio_preprocess_user_register_form')
      );
    ...
    * Fahico...!
    */
   function bootstrap_barrio_preprocess_user_register_form(&$vars){
    ...
    * Fahico...!
    */
   function bootstrap_barrio_preprocess_user_login(&$vars){
